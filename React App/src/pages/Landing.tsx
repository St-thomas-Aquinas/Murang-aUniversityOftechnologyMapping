...
// Murang'a University of Technology actual coordinates and rooms
const mutRooms: Room[] = [
  // Academic Buildings
  { room_name: "Main Library", building: "Library Building", floor: "Ground Floor", lat: -0.6167, lon: 37.1500, category: 'academic' },
  { room_name: "ICT Lab 1", building: "ICT Block", floor: "1st Floor", lat: -0.6170, lon: 37.1505, category: 'academic' },
  { room_name: "ICT Lab 2", building: "ICT Block", floor: "2nd Floor", lat: -0.6170, lon: 37.1505, category: 'academic' },
  { room_name: "Engineering Lab", building: "Engineering Block", floor: "Ground Floor", lat: -0.6165, lon: 37.1510, category: 'academic' },
  { room_name: "Lecture Hall A", building: "Academic Block A", floor: "Ground Floor", lat: -0.6160, lon: 37.1495, category: 'academic' },
  { room_name: "Lecture Hall B", building: "Academic Block B", floor: "1st Floor", lat: -0.6175, lon: 37.1498, category: 'academic' },
  { room_name: "Science Lab", building: "Science Block", floor: "Ground Floor", lat: -0.6163, lon: 37.1507, category: 'academic' },
  
  // Administrative
  { room_name: "Admissions Office", building: "Administration Block", floor: "Ground Floor", lat: -0.6155, lon: 37.1490, category: 'administrative' },
  { room_name: "Finance Office", building: "Administration Block", floor: "1st Floor", lat: -0.6155, lon: 37.1490, category: 'administrative' },
  { room_name: "Dean's Office", building: "Administration Block", floor: "2nd Floor", lat: -0.6155, lon: 37.1490, category: 'administrative' },
  
  // Facilities
  { room_name: "Main Cafeteria", building: "Student Center", floor: "Ground Floor", lat: -0.6180, lon: 37.1485, category: 'facility' },
  { room_name: "Students Lounge", building: "Student Center", floor: "1st Floor", lat: -0.6180, lon: 37.1485, category: 'facility' },
  { room_name: "Main Auditorium", building: "Auditorium Block", floor: "Ground Floor", lat: -0.6172, lon: 37.1520, category: 'facility' },
  
  // Services
  { room_name: "Medical Center", building: "Health Center", floor: "Ground Floor", lat: -0.6185, lon: 37.1475, category: 'service' },
  { room_name: "Security Office", building: "Gate House", floor: "Ground Floor", lat: -0.6190, lon: 37.1480, category: 'service' },
  { room_name: "Bookshop", building: "Student Center", floor: "Ground Floor", lat: -0.6182, lon: 37.1483, category: 'service' }
];
  ...
  useEffect(() => {
    ...
    mutRooms.forEach(room => {
      ...
      const roomIcon = window.L.divIcon({
        ...
        html: `<div class="bg-white rounded-full w-8 h-8 shadow-lg border-2 border-gray-300 flex items-center justify-center text-sm">${icon}</div>`,
        iconSize: [32, 32],
        iconAnchor: [16, 16]
      });
